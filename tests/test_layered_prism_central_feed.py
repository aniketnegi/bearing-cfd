...
import meshing.layered_prism_central_feed as ported
...
CASES = {
    "strict_default": (
        PROJECT_ROOT / "out" / "strict_default",
        PROJECT_ROOT / "out" / "gmsh_preflight" / "preflight_report.json",
    ),
    "strict_case_e03_g20": (
        PROJECT_ROOT / "out" / "strict_case_e03_g20",
        PROJECT_ROOT / "out" / "gmsh_preflight_e03_g20" / "preflight_report.json",
    ),
}
