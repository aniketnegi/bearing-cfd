#+TITLE: Cavitation and Film-Rupture Model Comparison
...
| Track | Mechanism | Highest retained state | Status | Interpretation |
|---+---+---+---+---|
...
#+ATTR_ORG: :width 1100
[[file:../../../evidence/conical_journal/cavitation_four_track/geometry_mesh/film_thickness_map.png]]

** Mesh actually used

The retained Track A speed sweep uses the uniform =blockMesh= case linked in
the evidence section.  It is an unwrapped one-cell pseudo-layer; the solver
applies the conical radius, metric, and film thickness separately.  Tracks
B--D use the full three-dimensional O-grid film mesh.

| Check | Track A: Reynolds--JFO | Tracks B--D: 3-D VOF |
|---+---+---|
| topology | one uniform =256 x 1 x 80= Hex8 block | full Hex8 fluid volume |
| points | 41,634 | 1,364,688 |
| feed representation | 10 cell centres inside the nominal 4 mm circle; no cell zone | 396 boundary Quad4 faces |
| total cells | 20,480 | 1,252,800 |
| physical gap layers | none; one arbitrary pseudo-thickness cell | 12 |
| minimum Fluent-equivalent OQ | not reported for this case | 0.922660 |
| mean Fluent-equivalent OQ | not reported for this case | 0.970117 |
| cells below OQ 0.9 | not assessed | zero |
| OpenFOAM standard check | =Mesh OK=; maximum non-orthogonality 0 degrees | =Mesh OK= in all three cases |

At this resolution the geometric feed mask covers 15.559 mm2, 23.8% more
than the nominal circular area.  The mask is grid-dependent, so the accepted
speed sweep remains numerical sensitivity evidence rather than a
...
The image below belongs to a separate body-fitted reduced JFO candidate.  That
case has 20,640 cells, a 96-cell feed zone, a 32-face rim, minimum
Fluent-equivalent OQ 0.956754, and maximum OpenFOAM non-orthogonality 7.64865
degrees.  It uses 0.0277 Pa s viscosity and atmospheric rupture pressure, and
its retained continuation ends at 2000 rpm.  It did not produce the Track A
SAE 10W-40 speed sweep above.
...
#+ATTR_ORG: :width 1100
[[file:../../../evidence/conical_journal/oq90_3d/full_3d_fluent_oq_overview.png]]

#+CAPTION: Local O-grid construction around the 4 mm circular surface feed.
#+ATTR_ORG: :width 700
[[file:../../../evidence/conical_journal/cavitation_four_track/geometry_mesh/local_master_mesh.png]]

* Lubricants and simulation inputs

The conical-bearing paper does not specify the properties of its V-32 oil.
The models below therefore use separately cited surrogate lubricants.
...
SAE 10W-40 value is not called a paper match because its viscosity differs.
...
#+ATTR_ORG: :width 1100
[[file:../../../evidence/conical_journal/cavitation_four_track/screening_diagnostics.png]]

#+CAPTION: Track B oil-fraction and absolute-pressure fields at the final preserved 28 rpm hold.
#+ATTR_ORG: :width 900
[[file:../../../evidence/conical_journal/cavitation_four_track/track_b_vapour/alpha_oil_003.png]]

#+CAPTION: Track C oil-fraction field at the failed zero-speed gate.
#+ATTR_ORG: :width 900
[[file:../../../evidence/conical_journal/cavitation_four_track/track_c_gas/alpha_oil_002.png]]

#+CAPTION: Track D oil-fraction field at the rejected 3500 rpm startup.
#+ATTR_ORG: :width 900
[[file:../../../evidence/conical_journal/cavitation_four_track/track_d_ventilation/alpha_oil_002.png]]

Static frames are not evidence of convergence.  The corresponding checkpoint
animations are:

- [[file:../../../evidence/conical_journal/jfo_sae10w40/converged_checkpoints.mp4][Track A checkpoints, MP4]]
- [[file:../../../evidence/conical_journal/cavitation_four_track/track_b_vapour/phase_states.mp4][Track B oil-vapour states, MP4]]
- [[file:../../../evidence/conical_journal/cavitation_four_track/track_c_gas/phase_states.mp4][Track C gas states, MP4]]
- [[file:../../../evidence/conical_journal/cavitation_four_track/track_d_ventilation/phase_states.mp4][Track D ventilation states, MP4]]
- [[file:../../../evidence/conical_journal/cavitation_four_track/track_d_ventilation/pressure_startup.mp4][Track D pressure startup, MP4]]

* Conclusions and open questions

** Conclusion

Reynolds--JFO is the current working model for mass-conserving film rupture.
It passed the declared numerical checks, while the oil-vapour calculation did
not settle, the non-condensable-gas case failed its zero-speed conservation
check, and the ventilation case produced negative absolute pressure before air
could propagate through the film-only domain.  These outcomes do not establish
that JFO represents the physical cavity mechanism in the test bearing.
...
3. Resume one selected 3-D mechanism only after fixing its failed gate and
   obtaining the missing properties and boundary evidence.
...
- Compact machine-readable ledger:
  [[file:../../../evidence/conical_journal/cavitation_four_track/mechanism_summary.csv][mechanism_summary.csv]]
- Track A OpenFOAM case:
  [[file:../../../cases/conical_journal/openfoam/jfo_sae10w40/][jfo_sae10w40]]
- Tracks B--D input dictionaries:
  [[file:../../../studies/conical_journal/cavitation_four_track/inputs/][cavitation_four_track/inputs]]
- Study manifest and source-artifact hashes:
  [[file:../../../studies/conical_journal/cavitation_four_track/study.json][study.json]]
- Full 3-D mesh quality summary:
  [[file:../../../evidence/conical_journal/oq90_3d/full_3d_fluent_oq_summary.json][full_3d_fluent_oq_summary.json]]
