...
15. [[file:15-jfo-validation-and-fluent.org][JFO validation and Fluent path]] -- published kernel benchmark, grid/feed audit, remaining numerical gates, and the separate Fluent vapour-or-air model.
