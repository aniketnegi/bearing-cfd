...
| Four-track sourced cavitation screen | *A accepted numerically; B/C unsettled; D rejected* | JFO reaches 4000 rpm; oil vapour reaches unsettled onset; gas fails the zero-speed mass gate; ventilation reaches inadmissible negative absolute pressure |
...
16. [[file:16-four-track-cavitation-results.org][Four-track cavitation results]] -- exact geometry, meshes, surrogate lubricants, executed A--D outcomes, plots, animations, paper comparison, and professor talking points.
...
- Four-track compact results: [[file:media/cavitation_four_track/CLIFF_NOTES.md][CLIFF_NOTES.md]]
- Four-track plots and animations: [[file:media/cavitation_four_track/][cavitation_four_track]]
