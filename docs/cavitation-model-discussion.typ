...
#text(size: 8pt, fill: grey)[
  Prepared from project results generated 30 July 2026; Track A mesh
  provenance corrected 2 August 2026. Green means a declared numerical gate
  passed—not experimental validation. Unsettled and rejected states are
  retained as evidence and are not promoted to performance results.
]
...
#v(5pt)
#image("../evidence/conical_journal/cavitation_four_track/four_track_status.png", width: 100%)
...
#v(5pt)
#figure(
  image("../evidence/conical_journal/cavitation_four_track/geometry_mesh/film_thickness_map.png", width: 100%),
  caption: [
...
#table(
  ...
  [Representation], [Uniform unwrapped pseudo-layer], [Full conical film volume],
  [Resolution], [256 × 1 × 80; 20,480 Hex8], [1,252,800 Hex8; 12 gap layers],
  [Points], [41,634], [1,364,688],
  [Pressure feed], [10 geometric cells; no cell zone], [396 boundary Quad4 faces],
  [Minimum Fluent-equivalent OQ], [not reported], [0.922660],
  [Mean Fluent-equivalent OQ], [not reported], [0.970117],
  [Cells below OQ 0.9], [not assessed], [0],
  [OpenFOAM check], [`Mesh OK`; max non-orthogonality 0°], [standard `checkMesh`: Mesh OK],
)

#v(5pt)
#text(size: 8.2pt)[
  Track A selects cell centres inside the nominal 4 mm circle. At 256 × 80
  this grid-dependent mask contains 10 cells and covers 15.559 mm², 23.8%
  above the nominal circular area.
]

#v(4pt)
#text(size: 8.2pt)[
  *Separate candidate.* The image below shows a 20,640-cell body-fitted
  reduced JFO mesh with a 96-cell feed zone and 32-face rim. It uses different
  lubricant and rupture-pressure inputs and ends at 2000 rpm; it did not
  produce the retained Track A sweep.
]

#v(4pt)
#figure(
  image("../evidence/conical_journal/cavitation_four_track/geometry_mesh/accepted_geometry_and_mesh.png", width: 100%),
  caption: [Separate body-fitted reduced JFO candidate; not the source of the retained Track A results.],
)

#v(3pt)
#figure(
  image("../evidence/conical_journal/oq90_3d/full_3d_fluent_oq_overview.png", width: 68%),
  caption: [
...
#image("../evidence/conical_journal/cavitation_four_track/paper_comparison_and_higher_rpm.png", width: 100%)
...
#figure(
  image("../evidence/conical_journal/jfo_sae10w40/final_fields_4000rpm.png", width: 87%),
  caption: [
...
#image("../evidence/conical_journal/cavitation_four_track/screening_diagnostics.png", width: 100%)
...
#grid(
  ...
  gutter: 4mm,
  [
    #image("../evidence/conical_journal/cavitation_four_track/track_b_vapour/alpha_oil_003.png", width: 100%)
    #align(center)[#text(size: 7.2pt, weight: "semibold")[B · oil vapour]]
  ],
  [
    #image("../evidence/conical_journal/cavitation_four_track/track_c_gas/alpha_oil_002.png", width: 100%)
    #align(center)[#text(size: 7.2pt, weight: "semibold")[C · free gas]]
  ],
  [
    #image("../evidence/conical_journal/cavitation_four_track/track_d_ventilation/alpha_oil_002.png", width: 100%)
...
#text(size: 8pt, fill: grey)[
  ...
  `evidence/conical_journal/cavitation_four_track/`; the accepted JFO animation is
  under `evidence/conical_journal/jfo_sae10w40/`. Animation shows saved solver
...
The repository contains `openfoam/solvers/jfoBearingFoam` and the
